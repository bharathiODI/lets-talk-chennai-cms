...
export default function LetsTalkChennaiFAQBlockComponent({
  ...
  return (
    <section className="relative overflow-hidden bg-white py-8 md:py-12 text-slate-900">
      ...
      <div className="relative z-10 container max-w-5xl mx-auto px-4 sm:px-6">
        ...
        {faqs && faqs.length > 0 && (
          <div className="mt-6 md:mt-8 flex flex-col gap-3 md:gap-4 max-w-[1000px] mx-auto">
        ...
        {ctaText && ctaUrl && (
          <div className="mt-8 md:mt-10 text-center">
            <a
              href={ctaUrl}
              className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#FF0F72] to-[#7B16C9] px-6 py-3 text-xs md:text-sm font-bold text-white shadow-[0_10px_30px_rgba(255,15,114,0.3)] transition-all duration-300 hover:scale-105 hover:shadow-[0_15px_35px_rgba(255,15,114,0.5)] active:scale-95 uppercase tracking-widest"
            >
              <span>{ctaText}</span>
